...
let torontoData = "https://raw.githubusercontent.com/zoomdmartin02/Mapping_Earthquakes/main/torontoRoutes.json";
...
L.geoJson(data, {
  ...
  onEachFeature: function(feature, layer) {
    layer.bindPopup("<h3> Airline: " + feature.properties.airline + "</h3> <br><h3> Destination: " + feature.properties.dst + "</h3>");
  }
}).addTo(map);
});